...
export default function Login() {
  ...
  const parseAuthError = (err) => {
    ...
    if (code === "auth/popup-closed-by-user") {
      setError("Sign-in cancelled. You closed the popup before completing.");
            ...
            <div className="md:col-span-5 p-8 sm:p-12 flex flex-col justify-between bg-[#131d33]/50 relative overflow-hidden">
              ...
              <div className="flex flex-col items-center justify-center my-auto text-center py-6 relative z-10">
                ...
                <button
                  ...
                  disabled={!!loadingAction}
                  className="w-full bg-[#1b253b] hover:bg-[#242f4c] border border-white/10 hover:border-white/20 text-white font-bold py-4 px-6 rounded-xl transition-all shadow-xl flex items-center justify-center gap-3 text-sm group relative overflow-hidden"
                >
